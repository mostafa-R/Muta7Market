...
const API_URL = `${process.env.NEXT_PUBLIC_API_BASE_URL}/players?job=coach`;
...
export default function CoachesPage() {
  ...
  const { ads: coachAds, loading: adsLoading } = useAdvertisements(
    "coaches",
    settings
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-muted">
        ...
        <div className="my-8">
          {adsLoading || settingsLoading ? (
            ...
            coachAds.map((ad) => <AdvertisementRenderer key={ad._id} ad={ad} />)
          ) : null}
        </div>
