            ...
            {!idParam && canPay && (
              <div className="mt-6 p-6 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-100 shadow-sm animate-fade-in">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    <PaymentBtn type="publish_profile" playerId={player?._id} />
                  </Suspense>
                </div>
              </div>
            )}

            {/* Publish profile payment for existing profiles (management) */}
            {idParam && player && player.isActive === false && (
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-blue-700">
                      {t("registerProfile.publish.promptTitle", { defaultValue: "Publish your profile" })}
                    </h3>
                    <p className="text-blue-700/80">
                      {t("registerProfile.publish.promptDesc", { defaultValue: "Complete payment to publish your profile and make it visible." })}
                    </p>
                  </div>
                </div>
                <div className="flex justify-center">
                  <Suspense
                    fallback={
                      <div className="py-4 text-center text-gray-500">جاري التحميل...</div>
                    }
                  >
                    <PaymentBtn type="publish_profile" playerId={player?._id} />
                  </Suspense>
