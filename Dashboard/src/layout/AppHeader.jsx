              ...
              dropdownOpen 
                ...
                <div className="py-2">
                  <button
                    ...
                    className="group flex w-full items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700 transition-all duration-300 gap-2"
                  >
                  ...
                  <button
                    ...
                    className="group flex w-full items-center px-4 py-3 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-all duration-300 gap-2"
                  >
