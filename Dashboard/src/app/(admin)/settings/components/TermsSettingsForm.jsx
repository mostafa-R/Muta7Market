      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex gap-2">
          ...
          <Button 
            ...
            className="bg-red-800 hover:from-red-600 text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2 text-sm font-medium"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
