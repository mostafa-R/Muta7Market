...
export default function AvatarPage() {
  return (
    <>
      <Head>
        <title>Next.js Avatars | TailAdmin - Next.js Dashboard Template</title>
        <meta
          name="description"
          content="This is Next.js Avatars page for TailAdmin - Next.js Tailwind CSS Admin Dashboard Template"
        />
      </Head>
      <div>
