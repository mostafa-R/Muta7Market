...
//     filter["promotion.isPromoted"] = isPromoted === "true";
...
//   res.status(200).json(
//     new ApiResponse(200, { offers, total }, "Offers fetched")
//   );
// });

// // Get One
// export const getOfferById = asyncHandler(async (req, res) => {
//   const offer = await OfferModel.findById(req.params.id).populate("user", "name email");
...
//   if (!offer) throw new ApiError(404, "Offer not found or unauthorized");
